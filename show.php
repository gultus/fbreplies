...
$posts = FBUtils::fql(
"SELECT post_id, permalink,actor_id, target_id, message,description,comments,likes,app_id,action_links,attachment FROM stream WHERE source_id = me() AND strlen(description) = 0 AND created_time >= ".$_REQUEST['startdate']." AND created_time <= ".$_REQUEST['enddate']." LIMIT 100",
$token
);
